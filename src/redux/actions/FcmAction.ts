    ...
    return (dispatch:any)=>{
        const onRegister = (token: string) => {
          ...
          const onNotification = (message: any) => {
            ...
            if(message){
                handleNotificationLocally(message)
            }
          }
      
          const onNotificationOpened = (message: any) => {
            // console.log({ message }, 'backOrInactive')
            if(message){
                handleNotificationLocally(message)
            }
          }
          fcmService.register(onRegister, onNotification, onNotificationOpened)
    }
}

export const handleNotificationLocally = (message?:any)=>{
